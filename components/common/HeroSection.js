...
const HeroSection = ({ content, description }) => {
  return (
    <div>
      <h1 className='text-2xl sm:text-4xl md:text-5xl lg:text-7xl text-black text-opacity-80 font-light !leading-[42px] sm:!leading-[48px] md:!leading-[70px] lg:!leading-[87.14px] z-10'>
        {content}
      </h1>
      {description && (
