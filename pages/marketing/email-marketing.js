    ...
    <Layout>
          ...
          <HeroSection
            ...
            content={
              <span className='text-3xl md:text-4xl lg:text-6xl xl:text-7xl'>
                Sending curated content to a specific audience
              </span>
            }
            description={
              <>
                Third Eye provides a variety of email marketing services that
                are customised to the needs, spending limit, and target market
                segments of your brand. For generating business leads and
                providing a high return on investment, online email marketing is
                one of the best marketing strategies. We offer email marketing
                services to individuals, small businesses, corporations, and
      ...
      <div className='sm:mt-24 mt-14  my-10 container '>
        <h3 className='lg:mt-6 text-lg  sm:text-xl lg:text-2xl text-black text-opacity-80'>
          We Ensure high delivery and sender reputation of your emails with an
          extensive list of domain best practices and an in-house team of
      ...
      <TechStack
        ...
        classes='max-w-7xl'
      />
      <OurWorks title='Eamil Marketing Works' tag='EMAIL' />
      {/* <GrowWithUs /> */}
      <ImpactCreated />
      <Blogs />
