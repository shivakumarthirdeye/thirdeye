...
const Projects = ({ page }) => {
  ...
  return (
    <Layout>
      <section className='sm:px-4 my-10 lg:my-20'>
        <div className='max-w-[964px]   mx-auto  sm:border border-black'>
          <div>
            <div className='p-4 py-7 sm:p-9 sm:py-10'>
            ...
            {!applying ? (
              <div>
                <div>
                  <div className='bg-[#BAE7E4] p-9 py-2.5 border-y border-black border-opacity-30'>
                    <h2 className=' text-xl md:text-[22px] font-semibold'>
                      Description
                    </h2>
                  </div>
                  <div className='p-4 py-8 sm:p-9 sm:py-10'>
                ...
                <div>
                  ...
                  <div className='p-4 py-8 sm:p-9 sm:py-10'>
                    <div className='flex justify-center sm:justify-end space-x-2 sm:space-x-4 md:space-x-6'>
                      <Link href={`/careers`}>
                        <a className='h-[45px] flex items-center border  border-black border-opacity-[16%]  justify-center max-w-[117px] w-full bg-black bg-opacity-[16%] rounded'>
                          Back
                        </a>
                      </Link>
                      <button
                        ...
                        <div className='py-5 md:flex justify-between items-center '>
                          ...
                          <div className='flex-1 flex justify-center mt-16 md:mt-0 md:justify-end space-x-2 sm:space-x-4 md:space-x-6'>
                            <button
                              ...
                              className='h-[45px] border border-black border-opacity-[16%] flex items-center  justify-center max-w-[117px] w-full bg-black bg-opacity-[16%] rounded'
                            >
                              Back
                            </button>
                            <button
